...
const features = [
  {
    ...
    description: 'LEARNIVERSE\'s AI understands the context of your course materials, topics, and previous questions. Instead of generic answers, you get explanations tailored to what you\'re currently studying and where you might be struggling.',
  ...
  },
  {
    ...
    description: 'Keep all your learning materials in one organized place. LEARNIVERSE structures everything by course, topic, and subtopic so you can easily find resources, connect ideas, and study without digging through scattered files.',
  ...
  },
  {
    ...
    description: 'LEARNIVERSE monitors your progress and upcoming academic deadlines. If you start falling behind or an exam is approaching, the system adapts your study plan and suggests what to focus on next.',
  ...
  },
  {
    ...
    description: 'Track your mastery across courses and topics with clear visual indicators. LEARNIVERSE helps you identify weak areas early so you can focus your time where it matters most before exams.',
  ...
  },
  {
    ...
    description: 'Instead of forgetting what you studied last week, LEARNIVERSE sends smart reminders and quick review prompts that reinforce important ideas, helping you retain knowledge for the long term.',
      ...
      <div className=" mx-auto space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600">
            LEARNIVERSE doesn&apos;t just store your notes. It actively helps you understand them, remember them, and ace your exams.
          </p>
        </div>
