    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50/30 flex items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <form
          ...
          className={`bg-white/70 backdrop-blur-xl border border-gray-100 rounded-3xl p-6 sm:p-8 shadow-sm space-y-5 ${outfit.className}`}
        >
          {/* Full Name */}
          <div>
        ...
        <p className={`text-center text-sm text-gray-400 mt-3 ${outfit.className}`}>
